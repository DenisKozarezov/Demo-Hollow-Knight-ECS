...
public partial class GameEntity {
    ...
    public Core.ECS.Components.Units.Id id { get { return (Core.ECS.Components.Units.Id)GetComponent(GameComponentsLookup.Id); } }
    ...
    public void AddId(int newValue) {
        ...
        var component = (Core.ECS.Components.Units.Id)CreateComponent(index, typeof(Core.ECS.Components.Units.Id));
