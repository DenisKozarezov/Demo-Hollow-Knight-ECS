...
public partial class GameEntity {
    ...
    public void AddJumpingListener(System.Collections.Generic.List<IJumpingListener> newValue) {
    ...
    public void ReplaceJumpingListener(System.Collections.Generic.List<IJumpingListener> newValue) {
        var index = GameComponentsLookup.JumpingListener;
        var component = (JumpingListenerComponent)CreateComponent(index, typeof(JumpingListenerComponent));
        component.value = newValue;
    ...
    public void RemoveJumpingListener() {
