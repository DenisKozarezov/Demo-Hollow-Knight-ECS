...
public partial class GameEntity {
    ...
    public void AddGroundedListener(System.Collections.Generic.List<IGroundedListener> newValue) {
    ...
    public void ReplaceGroundedListener(System.Collections.Generic.List<IGroundedListener> newValue) {
        var index = GameComponentsLookup.GroundedListener;
        var component = (GroundedListenerComponent)CreateComponent(index, typeof(GroundedListenerComponent));
        component.value = newValue;
    ...
    public void RemoveGroundedListener() {
