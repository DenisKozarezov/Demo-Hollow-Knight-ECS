...
public partial class GameEntity {
    ...
    public void AddMovingListener(System.Collections.Generic.List<IMovingListener> newValue) {
    ...
    public void ReplaceMovingListener(System.Collections.Generic.List<IMovingListener> newValue) {
        var index = GameComponentsLookup.MovingListener;
        var component = (MovingListenerComponent)CreateComponent(index, typeof(MovingListenerComponent));
        component.value = newValue;
