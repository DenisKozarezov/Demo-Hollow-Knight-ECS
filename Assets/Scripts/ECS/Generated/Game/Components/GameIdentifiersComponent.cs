...
public partial class GameContext {
    ...
    public GameEntity SetIdentifiers(IIdentifierService newValue) {
        if (hasIdentifiers) {
    ...
    public void ReplaceIdentifiers(IIdentifierService newValue) {
...
public partial class GameEntity {
    ...
    public void AddIdentifiers(IIdentifierService newValue) {
