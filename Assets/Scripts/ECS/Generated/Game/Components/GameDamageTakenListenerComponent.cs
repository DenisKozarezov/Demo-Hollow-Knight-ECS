...
public partial class GameEntity {
    ...
    public void AddDamageTakenListener(System.Collections.Generic.List<IDamageTakenListener> newValue) {
    ...
    public void ReplaceDamageTakenListener(System.Collections.Generic.List<IDamageTakenListener> newValue) {
        var index = GameComponentsLookup.DamageTakenListener;
        var component = (DamageTakenListenerComponent)CreateComponent(index, typeof(DamageTakenListenerComponent));
        component.value = newValue;
    ...
    public void RemoveDamageTakenListener() {
