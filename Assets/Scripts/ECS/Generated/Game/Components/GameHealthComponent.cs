...
public partial class GameEntity {
    ...
    public Core.ECS.Components.Units.HealthComponent health { get { return (Core.ECS.Components.Units.HealthComponent)GetComponent(GameComponentsLookup.Health); } }
    ...
    public void AddHealth(int newHealth, int newMaxHealth) {
        ...
        var component = (Core.ECS.Components.Units.HealthComponent)CreateComponent(index, typeof(Core.ECS.Components.Units.HealthComponent));
