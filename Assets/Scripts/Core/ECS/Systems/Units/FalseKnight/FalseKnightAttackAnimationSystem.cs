...
namespace Core.ECS.Systems.FalseKnight
{
    internal class FalseKnightAttackAnimationSystem : IEcsRunSystem
    {
        ...
        private readonly EcsFilter<AnimatorComponent, FalseKnightAttackEventComponent>.Exclude<DiedComponent> _filter = null;
        ...
        public void Run()
        {
            ...
            {         
                ...
                ecsEntity.Get<AnimatorComponent>().Value.SetTrigger("Attack");
